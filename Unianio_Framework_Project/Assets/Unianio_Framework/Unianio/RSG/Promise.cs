using Unianio.RSG.Promises;
using System;
using System.Collections.Generic;
using System.Linq;
using Unianio.RSG.Exceptions;
using UnityEngine;

namespace Unianio.RSG
{
    /// <summary>
    /// Original: https://github.com/Real-Serious-Games/C-Sharp-Promise
    ///
    /// 
...
//            Argument.NotNull(() => ex);
        ...
        public IPromise Catch(Action<Exception> onRejected)
        {
            ...
            Action<Exception> rejectHandler = ex =>
            {
                ...
                {
                    Debug.LogError("PROMISE ERROR: " + cbEx);
...
//            Argument.NotNull(() => onResolved); 
            ...
            Action<Exception> rejectHandler = ex =>
            {
                ...
                {
                    Debug.LogError("PROMISE ERROR: " + callbackEx);
        ...
        public IPromise<PromisedT> Finally(Action onComplete)
        {
            ...
            this.Catch(e => {
                try {
                    ...
                    Debug.LogError("PROMISE ERROR: " + ne);
                    promise.Reject(ne);
                }
            });
