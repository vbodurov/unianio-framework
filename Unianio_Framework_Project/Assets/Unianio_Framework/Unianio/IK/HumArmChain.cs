...
{
    public class HumArmChain : BaseIkChain, IInitialOrientationHolder
    {
        readonly HumanoidPart _part;
        readonly IComplexHumanDefinition _definition;
        public readonly Transform Collar, Shoulder, Shoulder2, ShoulderTwist, Forearm, ForearmTwist, Hand,
            Index0, Index1, Index2, Index3,
            Middle0, Middle1, Middle2, Middle3,
            Ring0, Ring1, Ring2, Ring3,
            Pinky0, Pinky1, Pinky2, Pinky3,
            Thumb1, Thumb2, Thumb3;
        public readonly HumBoneHandler HandHandler;
        readonly bool _isRight, _hasComplexShoulder;
        readonly float _distHandToElbow,_distElbowToShoulder,_maxStretch;
        ...
        public HumArmChain(HumanoidPart part, IComplexHumanDefinition definition) : base(part)
        {
            _part = part;
            _isRight = part == HumanoidPart.ArmR;
            ...
            Hand = arm.Hand;
            _handle = CreateHandle(Collar, _part, false, Hand.position, Hand.forward, Hand.up);

            HandHandler = new HumBoneHandler(_isRight ? HumanoidPart.HandR : HumanoidPart.HandL, _model, Hand);
            ...
            _maxStretch = (_distHandToElbow + _distElbowToShoulder);
...
//                dbg.DrawPointersChain(this.hc() * 200, _tempShoulderPoints);
        ...
        public HumArmChain RotateHandsAwayFromShoulder(double degreesPerSec = 90)
        {
        ...
        public HumArmChain RotateHandsAwayFromShoulder(in Vector3 upDirInWorld, double degreesPerSec = 90)
        {
        ...
        public HumArmChain EnsurePosition(in Vector3 candidate)
        {
        ...
        public HumArmChain SetOptimalRotation(double degreesPerSec)
        {
