...
namespace Unianio.Graphs
{
    ...
    public static class BezierFunc
    {
        ...
        static void GetCubicCoefficients(double a, double b, double c, double d, out double c0, out double c1, out double c2, out double c3)
        {
            c0 = -a + 3 * b - 3 * c + d;
            c1 = 3 * a - 6 * b + 3 * c;
            c2 = -3 * a + 3 * b;
        ...
        static int GetQuadraticRoots(double a, double b, double c, out double r0, out double r1)
        {
            r0 = r1 = 0;
        ...
        static int GetCubicRoots(double a, double b, double c, double d, out double r0, out double r1, out double r2)
        {
            r1 = r2 = 0;
        ...
        static double GetSingleValue(double t, double a, double b, double c, double d)
        {
        ...
        public static Vector2 GetPointQuadratic2D(double progress, Vector2 start, Vector2 control, Vector2 end)
        {
        ...
        // end = control 2
        // p3 = end
        public static Vector2 GetPointCubic2D(double progress, Vector2 start, Vector2 control1, Vector2 control2, Vector2 end)
        {
        ...
        // control = control
        // end = end
        public static Vector2 GetPointQuadratic2D(double progress, ref Vector2 start, ref Vector2 control, ref Vector2 end)
        {
            // https://en.wikipedia.org/wiki/B%C3%A9zier_curve#Quadratic_B.C3.A9zier_curves
            // quadratic bezier formula is
            // [x,gety] = 
        ...
        public static Vector2 GetPointCubic2D(double progress, in Vector2 start, in Vector2 control1, in Vector2 control2, in Vector2 end)
        {
            // cubic bezier formula is
            // [x,gety] = 
            //      (1 - t)^3 * P0 + 
        ...
        // control = control
        // end = end
        public static Vector3 GetPointQuadratic(double progress, in Vector3 start, in Vector3 control, in Vector3 end)
        {
            // https://en.wikipedia.org/wiki/B%C3%A9zier_curve#Quadratic_B.C3.A9zier_curves
            // quadratic bezier formula is
            // [x,gety] = 
        ...
        public static Vector3 GetPointCubic(double progress, in Vector3 start, in Vector3 control1, in Vector3 control2, in Vector3 end)
        {
            // cubic bezier formula is
            // [x,gety] = 
            //      (1 - t)^3 * P0 + 
        ...
        public static float GetLengthCubic(Vector3 start, Vector3 control1, Vector3 control2, Vector3 end)
        {
            return GetLengthCubic(in start, in control1, in control2, in end, 16);
        }
        public static float GetLengthCubic(Vector3 start, Vector3 control1, Vector3 control2, Vector3 end, int segments)
        {
            return GetLengthCubic(in start, in control1, in control2, in end, 16);
        }
        public static float GetLengthCubic(in Vector3 start, in Vector3 control1, in Vector3 control2, in Vector3 end)
        {
            return GetLengthCubic(in start, in control1, in control2, in end, 16);
        }
        public static float GetLengthCubic(in Vector3 start, in Vector3 control1, in Vector3 control2, in Vector3 end, int segments)
        {
        ...
        public static float GetLengthQuadratic(Vector3 start, Vector3 control, Vector3 end)
        {
            return GetLengthQuadratic(in start, in control, in end, 16);
        }
        public static float GetLengthQuadratic(Vector3 start, Vector3 control, Vector3 end, int segments)
        {
            return GetLengthQuadratic(in start, in control, in end, 16);
        }
        public static float GetLengthQuadratic(in Vector3 start, in Vector3 control, in Vector3 end)
        {
            return GetLengthQuadratic(in start, in control, in end, 16);
        }
        public static float GetLengthQuadratic(in Vector3 start, in Vector3 control, in Vector3 end, int segments)
        {
            if(segments < 1 || segments > 2048)
                throw new ArgumentException("Segments must be between 1 and 2048");
        ...
        public static Vector3 GetFirstDerivativeQuadratic(double progress, in Vector3 start, in Vector3 control, in Vector3 end)
        {
            var t = Mathf.Clamp01((float)progress);
            var n = 1f - t;
            return 2f * n * (control - start) + 2f * t * (end - control);
        }
        public static Vector3 GetFirstDerivativeCubic(double progress, in Vector3 start, in Vector3 control1, in Vector3 control2, in Vector3 end)
        {
            var t = Mathf.Clamp01((float)progress);
	        var n = 1f - t;
